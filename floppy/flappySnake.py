...
bird_img = pygame.image.load("./floppy/assets/snake.png")
...
pipe_frames = deque()
pipe_img = pygame.image.load("./floppy/assets/pillar.png")

pipe_starting_template = pipe_img.get_rect()
space_between_pipes = 150

# load background music
pygame.mixer.music.load("./floppy/assets/music/arcade.wav")
...
class FlappySnake():
    ...
    def start():
        ...
        global time_between_pipe_spawn
        global game_clock
        ...
        min_tracking_confidence=0.5) as face_mesh:
            while run:
                ...
                if not game_is_running:
                    ...
                    screen.fill((238, 194, 255))
                    text = pygame.font.SysFont("Calibri.ttf", 64).render('Game over!', True, (109, 67, 126))
                    tr = text.get_rect()
                ...
                # Stage, score text
                text = pygame.font.SysFont("Calibri.ttf", 50).render(f'Stage {stage}', True, (255, 255, 255))
                ...
                text = pygame.font.SysFont("Calibri.ttf", 50).render(f'Score: {score}', True, (255, 255, 255))
                temp_surface = pygame.Surface(text.get_size())
                temp_surface.fill((109, 67, 126))
                temp_surface.blit(text, (0, 0))
