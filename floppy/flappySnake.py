...
# # load button images 
# exit_img = pygame.image.load("./floppy/assets/exit.png").convert_alpha()
...
# load button images
exit_img = pygame.image.load("button_quit.png").convert_alpha()

# create button instance
exit_button = Button(336, 375, exit_img, 0.4)
